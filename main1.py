...
parser.add_argument('--step', type=int, default=15, help='Sets the learning rate to the initial LR decayed by momentum every n epochs, Default: n=10')
...
def main():
    ...
    train_set = DatasetFromPandas('/storage03/user_data/liuchen01/creds/bank_combined_train_148_labels')
    test_set = DatasetFromPandas('/storage03/user_data/liuchen01/creds/bank_combined_test_148_labels')
...
def test(testing_data_loader, model):
    ...
    for batch in testing_data_loader:
        ...
        result.append(prediction.data.cpu().numpy())
